...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container-custom relative z-10 py-16">
          <div className="max-w-4xl mx-auto text-center text-white mb-16">
            ...
            <div className="inline-flex items-center gap-2 mb-6 animate-fade-in">
              <span className="bg-gradient-to-r from-yellow-400 to-orange-400 text-gray-900 px-5 py-2.5 rounded-full text-sm font-bold shadow-xl border-2 border-yellow-300/50 hover:scale-105 transition-transform">
                ✨ Hệ thống đặt phòng #1 Việt Nam
              </span>
            </div>
            
            {/* Main Heading */}
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 animate-fade-in leading-[1.1] tracking-tight">
            ...
            {/* Subtitle */}
            <p className="text-lg md:text-xl lg:text-2xl text-blue-100 animate-slide-up mb-4 leading-relaxed max-w-3xl mx-auto font-medium">
              Tìm kiếm hàng ngàn khách sạn với giá tốt nhất trên toàn quốc
            </p>
            <p className="text-base md:text-lg text-blue-200 animate-slide-up delay-100 mb-10">
              🚀 Đặt nhanh • 💰 Giá rẻ • ⭐ Uy tín
            </p>

            {/* Enhanced Stats */}
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 animate-slide-up delay-200 mb-12">
              <div className="group bg-white/15 backdrop-blur-lg rounded-2xl px-6 md:px-8 py-4 border border-white/30 shadow-2xl hover:bg-white/25 hover:scale-105 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-black bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">10,000+</div>
                <div className="text-xs md:text-sm text-blue-100 font-semibold mt-1">Khách sạn</div>
              </div>
              <div className="group bg-white/15 backdrop-blur-lg rounded-2xl px-6 md:px-8 py-4 border border-white/30 shadow-2xl hover:bg-white/25 hover:scale-105 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-black bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">50,000+</div>
                <div className="text-xs md:text-sm text-blue-100 font-semibold mt-1">Đặt phòng</div>
              </div>
              <div className="group bg-white/15 backdrop-blur-lg rounded-2xl px-6 md:px-8 py-4 border border-white/30 shadow-2xl hover:bg-white/25 hover:scale-105 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-black bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">4.8⭐</div>
                <div className="text-xs md:text-sm text-blue-100 font-semibold mt-1">Đánh giá</div>
              </div>
            </div>
          </div>
                  ...
                  <div className="relative h-80">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-6">
                      <div className="flex items-center text-white mb-3">
                        <FaMapMarkerAlt className="text-accent mr-2 text-xl" />
                        <span className="text-3xl font-bold">{destination._id}</span>
                      </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary-dark to-primary">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="bg-accent/20 w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <FaHotel className="text-accent text-4xl" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-3">Giá tốt nhất</h3>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Thanh toán an toàn</h3>
              <p className="text-gray-200 leading-relaxed">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="bg-accent/20 w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <FaHeadset className="text-accent text-4xl" />
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          <div className="bg-gradient-to-r from-primary to-primary-dark rounded-3xl p-12 md:p-16 text-center text-white relative overflow-hidden">
            {/* Decorative circles */}
            ...
            <div className="relative z-10">
              ...
              <Link 
                to="/search" 
                className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl"
              >
